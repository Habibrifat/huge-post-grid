...
function ep_render_post_style($style, $settings){
    switch ($style) {
        case 'style1':
            ...
            break;
        case 'style2':
            render_style2($settings);
            break;
        case 'style3':
            render_style3($settings);
            break;
        case 'style4':
            render_style4($settings);
            break;
        case 'style5':
            render_style5($settings);
            break;     
        case 'ep-style1':
            render_ep_style1($settings);
            break;
        case 'ep-style2':
            render_ep_style2($settings);
            break;
        case 'ep-style3':
            render_ep_style3($settings);
            break;
        case 'ep-style4':
            render_ep_style4($settings);
            break;
        case 'ep-style5':
            render_ep_style5($settings);
            break;
        default:
            // render_style1($settings);
            render_ep_style1($settings);
...
function render_style1($settings) {
    // Card Design
    echo '<div class="post-item style-2 default-style">';
